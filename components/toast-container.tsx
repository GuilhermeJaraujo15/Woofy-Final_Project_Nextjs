    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 flex flex-col gap-2 sm:left-auto">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={cn(
            "flex w-full min-w-0 items-center gap-3 rounded-lg px-4 py-3 shadow-lg transition-all duration-300 animate-in slide-in-from-right sm:w-auto sm:min-w-[300px] sm:max-w-[420px]",
            toast.type === "success"
